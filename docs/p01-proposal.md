# Ocean Plastic: Project Proposal

**Code Name:** Ocean Plastic

**Title:** Ocean Plastic: Where does it come from and what does that mean for us?

**Authors:** Julia Russel - jgrusse@uw.edu, Jasmine Wong - jwong100@uw.edu, Andy Nguyen - anguye7@uw.edu

**Affiliation:** 	INFO-201: Technical Foundations of Informatics - The Information School - University of Washington

**Date:** Autumn 2022

**Abstract:** We are concerned with plastic in the ocean because the state of our oceans are just as important as any other system on earth. To address this concern we plan to investigate where this ocean plastic is coming from, how effective are countermeasures against plastic waste, and how prevalent are micro plastics.
...
2. How are microplastics becoming part of the ocean ecosystem? What types of microplastics are prevalent?
  * Microplastics are becoming a part of our everyday lives and we don’t know the effects on our bodies they might cause. Thus it is important for us to understand how and where it is happening and what type of microplastics are the most prevalent.
...
4. What countries emit the most plastic waste?
...
2. Microplastic and Microparticle Data From Surface Water: San Francisco Bay and Adjacent Sanctuaries (San Francisco Estuary Institute. (2020, September 23). *Microplastic and microparticle data from Surface Water: San Francisco Bay and adjacent sanctuaries.* California Natural Resources Agency Open from https://data.cnra.ca.gov/dataset/microplastic-sf-bay)
...
3. Most common items found during the International Coastal Ocean Cleanup in 2020 (Ocean Conservancy. (2021, October 18). *Items found in Oceans Globally 2020.* Statista. Retrieved October 30, 2022, from https://www.statista.com/statistics/726724/weight-of-most-common-items-found-in-global-oceans/)
  * This data relates to the problem domain and the research question because it shows what type of ocean waste and plastic ends up on beaches, coastal areas, and shorelines. This data was collected by the Ocean Conservancy in 2021. The purpose of this data is to show what was collected on international beaches and coastal areas to inspire a lasting commitment to keep oceans clean. The data was collected by the Ocean Conservancy that hosts an International Coastal Cleanup movement where volunteers gather around the world to clean up beaches and coastal areas. The trash that is collected is sorted and counted by the Ocean Conservancy’s partners. This data is credible because it comes from an organization that works toward cleaning the ocean and conservation efforts. This data answers the research question.
  ...
  4. Plastic Pollution - Plastic Emitted to Ocean per Capita (Ritchie, H., & Roser, M. (2018, September 1). *Plastic pollution.* Plastic Pollution. Retrieved October 30, 2022, from https://ourworldindata.org/plastic-pollution)
...
5. Plastic Ingestion by Marine Fish (Savoca, M.S., McInturf, A.G. and Hazen, E.L. (2021), *Plastic ingestion by marine fish is widespread and increasing.* Glob Change Biol, 27: 2188-2199. https://doi.org/10.1111/gcb.15533)
...
### Limitations
Some limitations we would need to address is how we can make these practices sustainable. Many of today’s goods and necessities are created with plastic. Furthermore, plastic is cheap to produce. Plastic plays an essential role in the lives of millions of people; almost everything we use is made of plastic. Therefore, we need to find a way to encourage the use of non plastics. If we can find alternatives to plastics, we need to make sure that they are cheap and affordable for people. How can we encourage people to abandon plastic in their lives? Additionally, we need to make sure that these alternatives do not also harm the planet as well. Not only do we need to think about the people who use plastics, but we also need to consider the companies that produce it. These companies produce billions of dollars off of the production of plastic. Therefore, we also would need to go against these companies, and this could have a global impact. We need to find a way to go after these companies. Creating a plastic-free ocean and ecosystem not only requires us to think about what we should do now, but how we can also maintain it in the future.
